...
void setup() {
  ...
  xTaskCreatePinnedToCore(BLEScannerTask, "BLE Scanner Task", 8192, nullptr, 5, &TaskHandle_BLEScanner, 0);
  xTaskCreatePinnedToCore(distanceTask, "distance Task", 4096, nullptr, 1, nullptr, 0);
  xTaskCreatePinnedToCore(UITask, "UI Task", 4096, nullptr, 1, &UITaskHandle, 1);
  xTaskCreatePinnedToCore(buttonTask, "Button Task", 4096, nullptr, 1, &ButtonTaskHandle, 1);
  xTaskCreatePinnedToCore(RFIDTask, "RFID Task", 4096, nullptr, 2, &RFIDTaskHandle, 1);
  xTaskCreatePinnedToCore(resetButtonTask, "Reset button Task", 2048, nullptr, 2, nullptr, 1);
